      ...
      <div className="px-6 py-6">
        ...
        <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 flex items-start gap-3 mb-8">
          ...
          <p className="text-sm text-red-200/90 font-medium leading-relaxed">
            Use this form to report damaged bikes, illegal parking, or app bugs. In case of emergency, please call 112 or local authorities immediately.
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert("Report submitted successfully!"); router.back(); }}>
          ...
          <div>
            <label className="block text-sm font-bold text-slate-300 mb-2 ml-1">Bike ID (Optional)</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="block text-sm font-bold text-slate-300 mb-2 ml-1">Photo Evidence</label>
          ...
          <button type="submit" className="w-full py-4 bg-primary text-black font-bold rounded-xl shadow-glow-primary hover:scale-[1.02] transition-transform">
            Submit Report
          </button>
        </form>

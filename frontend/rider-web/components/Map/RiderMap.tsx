      ...
      >
        ...
        {displayBikes.map(bike => (
          <Marker key={bike.id} longitude={bike.lng} latitude={bike.lat} anchor="bottom" style={{ pointerEvents: 'auto' }}>
            <div className="flex flex-col items-center group cursor-pointer transform hover:scale-110 transition-transform relative">
              {/* Tooltip */}
        ...
        {/* Mock User Location */}
        <Marker longitude={3.3780} latitude={6.5230} anchor="center" style={{ pointerEvents: 'none' }}>
